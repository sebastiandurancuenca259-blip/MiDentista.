      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
        <div ref={titleRef} className="flex flex-col gap-4 text-left max-w-2xl">
          <div className="inline-flex items-center gap-2">
            ...
            <span className="text-xs font-bold tracking-widest uppercase text-[#0ea5e9]">Architectural Sanctuary</span>
          </div>
          ...
          <p className="text-base sm:text-lg font-light text-[#64748b] leading-relaxed">
            Step away from traditional clinical settings into a modern, calming space crafted with organic wood tones, natural sunlight, and spa-like amenities.
          </p>
        </div>
      </div>
      ...
      <div ref={galleryRef} className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="group relative rounded-3xl overflow-hidden shadow-lg border border-slate-200/60 aspect-[4/3] cursor-pointer">
          ...
          <div className="absolute bottom-6 left-6 right-6 text-white text-left">
            <p className="text-xs font-bold uppercase tracking-wider text-cyan-300 mb-1">Reception Suite</p>
            <h3 className="text-xl font-serif font-medium">Tranquil Lounge</h3>
          </div>
        </div>
        ...
        <div className="group relative rounded-3xl overflow-hidden shadow-lg border border-slate-200/60 aspect-[4/3] cursor-pointer">
          <img 
            alt="Treatment Room View" 
            className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out" 
            src="https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&q=80&w=1200"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a]/80 via-[#0f172a]/20 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
          <div className="absolute bottom-6 left-6 right-6 text-white text-left">
            <p className="text-xs font-bold uppercase tracking-wider text-cyan-300 mb-1">Operatory</p>
            <h3 className="text-xl font-serif font-medium">State-of-the-Art Care Suites</h3>
          </div>
        </div>
        ...
        <div className="group relative rounded-3xl overflow-hidden shadow-lg border border-slate-200/60 aspect-[4/3] cursor-pointer">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a]/80 via-[#0f172a]/20 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
          <div className="absolute bottom-6 left-6 right-6 text-white text-left">
            <p className="text-xs font-bold uppercase tracking-wider text-cyan-300 mb-1">Diagnostic Studio</p>
            <h3 className="text-xl font-serif font-medium">3D Digital Imaging Lab</h3>
          </div>
        </div>
